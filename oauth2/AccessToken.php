...
class AccessToken
{
    ...
    /**
     * @param  $tokenStorage   - REQUIRED Storage class for saving access token information
     * @param        $refreshStorage - OPTIONAL Storage class for saving refresh token information
     ...
     * @endcode
     */
    public function __construct( $tokenStorage,  $refreshStorage = null, array $config = array())
    {
